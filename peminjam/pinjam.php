...
<html lang="en">
  ...
  <div class="container">
    <div class="card-transparant" style="margin-top: 3rem;">
        <div class="row m-4">
            <?php
            ...
            <div class="col-sm-7">
                ...
                <!-- <div class="mb-3">
                        <input type="hidden" name="IDpeminjaman" class="form-control"  >
                    </div> -->
                <div class="mb-3">
                        <input type="hidden" name="IDbuku" class="form-control" required value="<?php echo $result['IDbuku'];?>" readonly>
                    </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <input type="text" name="jumlah_peminjaman" class="form-control" required id="exampleInputEmail1" aria-describedby="emailHelp" min="1" max="2" value="1">
                    </div>
                        <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Kode Peminjaman</label>
                        <input type="text" name="kode_pinjam" maxlength="4"class="form-control" required id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary"onclick="return confirm('Konfirmasi Peminjaman?')">Pinjam</button>
                <a href="buku.php" class="btn btn-dark text-white">Kembali</a>
                    </div>
